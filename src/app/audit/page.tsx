    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="mx-auto mt-24 max-w-3xl px-6 sm:px-8">
        ...
        <div className="space-y-6 text-lg leading-8 text-foreground">
          ...
          <div className="mt-8 question-card" style={{ borderLeft: '4px solid var(--gold)' }}>
      ...
      <section className="mx-auto mt-24 max-w-3xl px-6 sm:px-8">
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div className="question-card">
            <div className="text-3xl font-bold mb-4" style={{ color: 'var(--gold)' }}>1</div>
          ...
          <div className="question-card">
            <div className="text-3xl font-bold mb-4" style={{ color: 'var(--gold)' }}>2</div>
          ...
          <div className="question-card">
            <div className="text-3xl font-bold mb-4" style={{ color: 'var(--gold)' }}>3</div>
          ...
          <div className="question-card">
            <div className="text-3xl font-bold mb-4" style={{ color: 'var(--gold)' }}>4</div>
